...
# Create .env file
echo "PORT=5000" > .env
echo "MONGODB_URI=mongodb://localhost:27017/Kick_Avenue" >> .env
...
3. **Navigate to `Kick_Avenue` database** to view your data
...
- For MongoDB Atlas, use connection string: `mongodb+srv://user:pass@cluster.mongodb.net/Kick_Avenue`
