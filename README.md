# Kick_Avenue - E-commerce Application

Welcome to **Kick_Avenue**, a full-stack e-commerce web application for a shoe store, built with React (frontend) and Node.js/Express (backend).
...
# PORT=5000
# MONGODB_URI=mongodb://localhost:27017/Kick_Avenue
