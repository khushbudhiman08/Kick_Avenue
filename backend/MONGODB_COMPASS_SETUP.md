...
This guide will help you connect MongoDB Compass to your Kick_Avenue database.
...
- Look for **Kick_Avenue** database
- Click on it to expand

### Step 5: Explore Collections

Inside the `Kick_Avenue` database, you'll find these collections:
...
### With Database Name
```
mongodb://localhost:27017/Kick_Avenue
```

### With Authentication (if configured)
```
mongodb://username:password@localhost:27017/Kick_Avenue
```
...
📊 Database: mongodb://localhost:27017/Kick_Avenue
💡 Connect to MongoDB Compass using: mongodb://localhost:27017
```

### From MongoDB Compass
- You should see the `Kick_Avenue` database
...
2. It will look like:
   ```
   mongodb+srv://username:password@cluster.mongodb.net/Kick_Avenue
   ```
3. Update `.env` file:
   ```
   MONGODB_URI=mongodb+srv://username:password@cluster.mongodb.net/Kick_Avenue
   ```
...
3. Navigate to `Kick_Avenue` database
