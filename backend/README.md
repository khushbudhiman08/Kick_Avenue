# Kick_Avenue Backend API

Backend server for the Kick_Avenue e-commerce application built with Node.js, Express, and MongoDB.
...
3. **Start MongoDB**
   ...
   - Default connection: `mongodb://localhost:27017/Kick_Avenue`
